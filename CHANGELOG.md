...
- Install, update, and switch commands with explicit framework selection and optional Laravel UI Kit support.
...
- Light and dark README banners and screenshots and installation, upgrade, dashboard, and testing guides.
