...
use jeremykenedy\LaravelEmailDatabaseLog\Console\SwitchCommand;
use jeremykenedy\LaravelEmailDatabaseLog\Console\UpdateCommand;
use jeremykenedy\LaravelEmailDatabaseLog\View\DashboardComposer;
...
class LaravelEmailDatabaseLogServiceProvider extends ServiceProvider
{
    public function boot(): void
    {
        ...
        View::composer('email-log::*', DashboardComposer::class);
        ...
        if ($this->app->runningInConsole()) {
            ...
            $this->commands([InstallCommand::class, UpdateCommand::class, SwitchCommand::class]);
        }
    }
